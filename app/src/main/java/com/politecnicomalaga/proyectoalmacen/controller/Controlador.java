...
public class Controlador
{
    ...
    /*public String listarProductosPorPrecio(){
        String resultado = "";
        //Nos creamos una lista copiada temporal con la que trabajar para no modificar el modelo.
        List<Producto> copia = new ArrayList<>(misProductos);
        //Ordenamos por descripción utilizando compareTo y un BubbleSort
        for (int i = 0; i < copia.size() - 1; i++) { //Recorremos los prodcutos
            ...
            for (int j = 0; j < copia.size() - i - 1; j++) { //- i para no comparar nuevamente los ultimos
                ...
                CompararPorPrecio compActual = new CompararPorPrecio(pActual.getCodigoProducto(), pActual.getDescripcion(), pActual.getPrecio(), pActual.getStock());
                
                if (compActual.compare(pActual, pSiguiente) > 0) {
                    //Realizamos el cambio, si J es mas Grande que J+1
                    Producto temp = copia.get(j);
    ...
    public String listarProductosPorStock(){
        String resultado = "";
        //Nos creamos una lista copiada temporal con la que trabajar para no modificar el modelo.
        List<Producto> copia = new ArrayList<>(misProductos);
        //Ordenamos por descripción utilizando compareTo y un BubbleSort
        for (int i = 0; i < copia.size() - 1; i++) { //Recorremos los prodcutos
            ...
            for (int j = 0; j < copia.size() - i - 1; j++) { //- i para no comparar nuevamente los ultimos
                ...
                CompararPorStock compActual = new CompararPorStock(pActual.getCodigoProducto(), pActual.getDescripcion(), pActual.getPrecio(), pActual.getStock());
    ...
    public String listarProductosPorCodigo(){
        String resultado = "";
        //Nos creamos una lista copiada temporal con la que trabajar para no modificar el modelo.
        List<Producto> copia = new ArrayList<>(misProductos);
        //Ordenamos por descripción utilizando compareTo y un BubbleSort
        for (int i = 0; i < copia.size() - 1; i++) { //Recorremos los prodcutos
            ...
            for (int j = 0; j < copia.size() - i - 1; j++) { //- i para no comparar nuevamente los ultimos
                ...
                CompararPorCodigo compActual = new CompararPorCodigo(pActual.getCodigoProducto(), pActual.getDescripcion(), pActual.getPrecio(), pActual.getStock());
